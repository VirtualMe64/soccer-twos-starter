...
CHECKPOINT_PATH = os.path.join(
    ...
    "checkpoint/checkpoint_001966/checkpoint-1966"
)
...
class BertAgent(AgentInterface):
    def __init__(self, env: gym.Env):
        ...
        tune.registry.register_env("BertDummyEnv", lambda *_: BaseEnv())
        config["env"] = "BertDummyEnv"
